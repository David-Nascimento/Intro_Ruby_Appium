Given ("que acesso a tela Click Simples") do
    ...
    $driver.find_element(id: "io.qaninja.android.twp:id/tvNavTitle")
...
When ("faço um click simples") do
    $driver.find_element(id: "io.qaninja.android.twp:id/short_click").click
end

Then ("devo ver o texto: {string}") do | expect_message |
    expect(@toaster.toast.text).to eql expect_message
end


Given ("que acesso a tela Click Longooo") do
    @nav.tap_hamburger
...
When ("faço um click Longooo") do
    @button = $driver.find_element(id: "io.qaninja.android.twp:id/long_click")
    Appium::TouchAction.new.press(element: @button).wait(2000).release.perform
end

Then "devo ver o botão com o texto: {string}" do |expect_text|
